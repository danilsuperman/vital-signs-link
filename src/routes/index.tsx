            ...
            <section className="surface-card overflow-hidden">
              ...
              <div className="space-y-3 p-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button className="rounded-lg border border-border bg-card px-3 py-2 text-xs font-medium text-foreground hover:bg-muted">
                    Написать
                  </button>
                  <button className="rounded-lg gradient-primary px-3 py-2 text-xs font-semibold text-primary-foreground shadow-[var(--shadow-glow)]">
                    Консультация
                  </button>
                </div>
              </div>
              ...
              <div className="flex gap-2">
                {[Youtube, Send, Instagram, Music2].map((Icon, i) => (
                  <a
                    key={i}
                    href="#"
                    className="grid h-9 w-9 place-items-center rounded-lg bg-muted text-foreground hover:bg-primary hover:text-primary-foreground"
                  >
    ...
    >
      ...
      <div className="relative flex h-full flex-col">
        ...
        <div className="mt-auto flex flex-wrap gap-2 pt-4">
          <button className="inline-flex items-center gap-1.5 rounded-lg bg-white px-3 py-1.5 text-xs font-semibold text-primary shadow-[var(--shadow-md)] transition-transform hover:scale-[1.02]">
            {slide.cta} <ArrowRight className="h-3.5 w-3.5" />
          </button>
          {!compact && (
            <button className="rounded-lg bg-white/15 px-3 py-1.5 text-xs font-medium text-white hover:bg-white/25">
              {slide.secondary}
            </button>
          )}
        </div>
...
function SideAction({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-full rounded-lg px-3 py-2 text-xs font-semibold transition-all ${cls}`}
    >
      {label}
    </button>
  );
...
function CaseCard({
  ...
  return (
    <div className="surface-card p-4">
      ...
      <Link
        to="/treatment"
        className="mt-4 flex items-center justify-center gap-1.5 rounded-lg gradient-primary px-3 py-2.5 text-xs font-semibold text-primary-foreground shadow-[var(--shadow-glow)]"
      >
    ...
    <div className="surface-card p-4">
      ...
      <div className="mt-3 grid grid-cols-[1fr_auto] gap-2">
        <button
          ...
          className="rounded-lg gradient-primary px-3 py-2 text-xs font-semibold text-primary-foreground shadow-[var(--shadow-glow)]"
        >
          Присоединиться
        </button>
        <button
